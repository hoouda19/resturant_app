class Product {
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    this.describtion = json["description"];
    this.imageUrl = json["imageUrl"];
    this.smallPrice = json["smallPrice"].toDouble();
    this.mediumPrice = json["mediumPrice"].toDouble();
    this.bigPrice = json['bigPrice'].toDouble();
    this.id = json["id"];
  }
}
